...
def city_info(city_name):
	...
	imageUrl = "https://maps.googleapis.com/maps/api/place/photo?maxwidth=2000&photoreference=" + geo_images(latitude,longitude) + "&key=AIzaSyDPJuBOQjOllMxsNBkVTPLIJFevlRA7x2w"

	return render_template('city.html',stateName= state, cityName = city, weatherAlert = weatherAlert, dailyForecast = dailyForecast, currentTemp = currentTemp, cityImage = imageUrl)
